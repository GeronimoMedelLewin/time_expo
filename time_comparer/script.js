...
'"Es posible que no exista un movimiento uniforme con el cual medir exactamente el tiempo [absoluto]. Todos los movimientos pueden ser acelerados o retardados, pero el flujo del tiempo absoluto no puede ser alterado."', 
'"Escoger el propio tiempo es ganar tiempo"', "Compara otra vez ambos relojes", 
"Fracción de Tiempo"];
let Cguion = ["Albert Einstein", "Milan Kundera", "Platon", "Isaac Newton", "Sir Francis Bacon"];
let CPguion = [5, 6, 7, 8, 9];
